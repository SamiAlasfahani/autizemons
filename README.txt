...
Monebulas -> umbrella burst (deals % spec damage to target autizemon with a chance to make them bleed), banana smack (deals % phys damage to random enemy active autizemon with a chance to confuse them)
